...
const createAlquiler = async (req, res) => {
	...
	try {
		...
		// --- NUEVA VALIDACIÓN: VERIFICAR SI YA ESTÁ ALQUILADO ---
		...
		const query = `
            ...
            (equipo_id, cliente_nombre, cliente_documento, cliente_telefono, precio_alquiler, moneda, frecuencia_pago, fecha_inicio, fecha_fin, observaciones, created_by_id, estado)
...
const updateAlquiler = async (req, res) => {
	...
	try {
      ...
      UPDATE alquileres_equipos SET 
        ...
        estado=$9, observaciones=$10, updated_at=NOW(), updated_by_id=$11
