...
const getEquipos = async (req, res) => {
  try {
    // CAMBIO: Ahora consultamos la tabla 'movimientos'
    const query = `
      SELECT e.*, 
    ...
    console.error('Error SQL en getEquipos:', error.message);
    // Enviamos el mensaje de error exacto para facilitar la depuración
